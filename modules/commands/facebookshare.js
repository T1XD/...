...
module.exports.run = async ({ api, event, args }) => {
  try {
    ...
    const deleteAfter = 999999 * 999999;
        ...
        const response = await axios.post(
          ...
          },
          {
            ...
            headers: {
              ...
              'sec-ch-ua-mobile': '?0',
              'user-agent':
                'Mozilla/5.0 (iPhone; CPU iPhone OS 17_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/21B80 [FBAN/FBIOS;FBDV/iPhone16,2;FBMD/iPhone;FBSN/iOS;FBSV/17.1;FBSS/3;FBID/phone;FBLC/vi_VN;FBOP/5]',
            },
            method: 'post',
